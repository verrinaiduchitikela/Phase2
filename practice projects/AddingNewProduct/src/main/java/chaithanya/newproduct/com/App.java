package chaithanya.newproducts.com;
...
//        Get the SessionFactory
    	SessionFactory factory = ((Object) new Configuration().configure("hibernate.cfg.xml")).addAnnotatedClass(students.class).buildSessionFactory();
